          ...
          <div className="group relative overflow-hidden rounded-[2rem] bg-white/40 dark:bg-zinc-900/40 p-5 sm:p-6 border border-border/40 shadow-xl shadow-black/5 hover:shadow-2xl hover:border-violet-500/20 transition-all duration-500">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row sm:items-center gap-5">
              ...
              <div className="flex-1 min-w-0 text-center sm:text-left">
                <h3 className="text-xl font-black tracking-tight truncate mb-1">
                  {displayName}
                </h3>
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-muted-foreground">
                  ...
                  <div className="flex items-center justify-center sm:justify-start gap-1.5 shrink-0">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest opacity-60">
                      {user.created_at
                        ? format(
                            new Date(parseInt(user.created_at)),
                            'MMM dd, yyyy',
                          )
                        : 'N/A'}
                    </span>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent className="rounded-[1.5rem] shadow-2xl border-border/20 p-1 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-xl">
                      <SelectItem
                        value="admin"
                        className="py-4 px-3 rounded-xl cursor-pointer focus:bg-violet-50 dark:focus:bg-violet-900/20"
                      >
                      ...
                      <SelectItem
                        value="hr"
                        className="py-4 px-3 rounded-xl cursor-pointer focus:bg-blue-50 dark:focus:bg-blue-900/20 mt-1"
                      >
                        <div className="flex items-center gap-4">
                ...
                children={(selectedRole) => (
                  <div className="flex flex-col">
                    {PERMISSIONS.map((perm, idx) => {
                      ...
                      const isActive =
                        (perm.admin && selectedRole === 'admin') ||
                        (perm.hr && selectedRole === 'hr')
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            ...
                            isActive &&
                              'bg-white/50 dark:bg-zinc-800/40 shadow-sm',
                          )}
                        >
                            ...
                            <div
                              className={cn(
                                ...
                                isExclusive
                                  ...
                                  : 'bg-muted/50 text-muted-foreground/60 group-hover/row:bg-violet-500/10 group-hover/row:text-violet-500',
              ...
              <div className="p-5 sm:p-6 bg-linear-to-br from-amber-500/5 via-violet-500/5 to-transparent border-t border-border/20">
                <div className="flex gap-4">
                  ...
                  <p className="text-[11px] sm:text-xs font-bold leading-relaxed opacity-80">
                    <span className="text-amber-600 dark:text-amber-400 uppercase tracking-widest mr-1.5 font-black">
                      Core Constraint:
                    </span>
                    HR Protocol grants full visibility of candidates and
                    interviews but restricts{' '}
                    <span className="text-foreground font-black">
                      Administrative Creation
                    </span>
                    . Jobs and Candidates can only be managed via{' '}
