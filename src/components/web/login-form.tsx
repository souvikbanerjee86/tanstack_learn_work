...
import { AlertTriangleIcon, Loader2, Lock, LogIn, Mail } from 'lucide-react'
      ...
      startTransition(async () => {
        try {
          ...
          if (roleResponse.role != null) {
            ...
            setError(
              'Your account is created.You will be notified by admin when role will be assigned',
            )
          }
        } catch (error: any) {
          ...
          >
                ...
                children={(field) => {
                  ...
                  return (
                    <Field data-invalid={isInvalid} className="space-y-2">
                      <FieldLabel className="text-[11px] font-black uppercase tracking-widest opacity-60">
                        Email Address
                      </FieldLabel>
            ...
            <div className="space-y-4">
              <Button
                disabled={isPending}
                type="submit"
                className="w-full h-11 rounded-xl font-bold bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20 transition-all active:scale-[0.98]"
              >
                {isPending ? (
            ...
            {error && (
              ...
              >
                ...
                <AlertTitle className="text-xs font-black uppercase tracking-widest mt-0.5">
