    ...
    <div className="relative min-h-screen flex flex-col gap-10 p-4 md:p-10 lg:p-14 pb-20 bg-transparent overflow-hidden">
      ...
      <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 3 }).map((_, i) => (
          <div
            key={i}
            className="relative overflow-hidden rounded-[2.5rem] border border-border/60 bg-white/50 dark:bg-zinc-950/50 backdrop-blur-xl p-8 space-y-4"
          >
      ...
      <div className="flex flex-col gap-6 lg:hidden">
        {Array.from({ length: 4 }).map((_, i) => (
          <div
            key={i}
            className="rounded-3xl border border-border/60 bg-white/50 dark:bg-zinc-950/50 backdrop-blur-xl p-6 space-y-6 shadow-xl shadow-black/5"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <Skeleton className="h-12 w-12 rounded-2xl" />
