...
import { Briefcase, Calendar, FileText, Mail, User } from 'lucide-react'
import type { ColumnDef } from '@tanstack/react-table'

import type { EmailSyncRecord } from '@/lib/types'
import { cn } from '@/lib/utils'

export const emailSyncColumns: Array<ColumnDef<EmailSyncRecord>> = [
  {
    accessorKey: 'id',
    header: () => (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const status = row.getValue('processed')
      return (
