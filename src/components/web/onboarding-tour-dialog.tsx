...
const TOUR_SLIDES: TourSlide[] = [
    {
        ...
        description: 'Accelerate your entire hiring lifecycle. From intelligent requisition architecture to autonomous voice interviews and deep forensic rubrics.',
        icon: Sparkles,
    ...
    },
    {
        ...
        description: 'Create multi-parameter job listings with target experience, domain criteria, and location preferences. Filter with instant multi-token search.',
        icon: Briefcase,
    ...
    },
    {
        ...
        subtitle: 'Surface the best talent from your archive bank with vector matching',
        description: 'Our semantic matching engine evaluates candidates by context and aptitude rather than mere keyword repetition. Compare CVs directly against job descriptions.',
        icon: Compass,
    ...
    },
    {
        ...
        description: 'Candidates receive time-boxed magic links to complete interactive spoken interviews with an adaptive AI evaluator that listens, transcribes, and probes deeper.',
        icon: Mic,
    ...
    },
    {
        ...
        subtitle: 'Comprehensive scorecards, reasoning analysis, and verdict submissions',
        description: 'Review aggregate scores, candidate speech audio samples, question-by-question AI reasoning, and generate beautiful exportable PDF reports for hiring committees.',
        icon: FileText,
        ...
        <Dialog open={isOpen} onOpenChange={handleOpenChange}>
            ...
            >
                ...
                <div className="p-6 sm:p-8 space-y-6">
                    ...
                    <p id="tour-description" className="text-xs sm:text-sm text-foreground/80 leading-relaxed font-medium bg-muted/20 p-4 rounded-2xl border border-border/40">
                ...
                <div className="p-6 sm:p-8 pt-4 pb-6 bg-muted/20 border-t border-border/40 flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            <span>{currentStep === TOUR_SLIDES.length - 1 ? "Launch Workspace" : "Next Feature"}</span>
