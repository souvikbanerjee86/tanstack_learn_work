    ...
    <div className="flex flex-col gap-10 p-4 md:p-10 lg:p-14 pb-20 bg-transparent overflow-hidden">
          ...
          >
            <CardHeader className="space-y-4 pb-6 p-6">
              ...
              <div className="space-y-2">
                ...
                <Skeleton className="h-4 w-40 rounded-full opacity-10" />{' '}
                {/* Pill */}
              </div>
            </CardHeader>
          </Card>
      ...
      <div className="space-y-10">
        {Array.from({ length: 2 }).map((_, jobIdx) => (
          <div
            key={jobIdx}
            className="rounded-[2rem] border border-muted-foreground/10 p-8 bg-card/50 backdrop-blur-sm shadow-sm space-y-8"
          >
            {/* Folder Header Row */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 px-2">
              {Array.from({ length: 3 }).map((_, fileIdx) => (
                <div
                  key={fileIdx}
                  className="rounded-2xl border border-muted-foreground/5 p-4 space-y-4 bg-background/40"
                >
                  ...
                  <Skeleton className="h-3 w-full rounded-md opacity-10" />{' '}
                  {/* Path */}
