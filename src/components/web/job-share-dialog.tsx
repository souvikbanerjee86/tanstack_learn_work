...
function DynamicQrCodeSvg({
  ...
  const cells: Array<Array<boolean>> = Array(matrixSize)
    .fill(false)
  ...
  for (let r = 0; r < matrixSize; r++) {
    for (let c = 0; c < matrixSize; c++) {
      ...
      cells[r][c] =
        seed % 3 === 0 ||
        (r + c + (text.charCodeAt((r + c) % text.length) || 0)) % 2 === 0
    }
  }
  ...
  const socialLinks = [
    {
      ...
      icon: Linkedin,
      color:
        'hover:bg-[#0A66C2]/15 hover:text-[#0A66C2] hover:border-[#0A66C2]/30',
    ...
    },
    {
      ...
      icon: Twitter,
      color:
        'hover:bg-zinc-900/15 dark:hover:bg-zinc-100/15 hover:text-foreground hover:border-foreground/30',
    ...
    },
    {
      ...
      icon: MessageCircle,
      color:
        'hover:bg-[#25D366]/15 hover:text-[#25D366] hover:border-[#25D366]/30',
    ...
    },
    {
      ...
      icon: Mail,
      color:
        'hover:bg-indigo-500/15 hover:text-indigo-600 dark:hover:text-indigo-400 hover:border-indigo-500/30',
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <DialogDescription className="text-xs sm:text-sm text-muted-foreground font-medium">
                  Distribute this job link or scan the QR code to apply
                  directly.
                </DialogDescription>
              </div>
            </div>
        ...
        <div className="p-6 sm:p-7 space-y-6 max-h-[75vh] overflow-y-auto no-scrollbar">
          ...
          <div className="p-4 rounded-2xl bg-muted/40 border border-border/60 backdrop-blur-md space-y-2.5">
            <div className="flex items-center justify-between gap-2">
              ...
              <Badge
                variant="outline"
                className="text-[10px] font-black uppercase tracking-wider bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border-indigo-500/20 shrink-0"
              >
                {job.status || 'Active'}
              </Badge>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-5 p-4 rounded-2xl bg-white/40 dark:bg-zinc-900/40 border border-border/50 backdrop-blur-sm">
            ...
            <div className="space-y-2 text-center sm:text-left">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Candidates can point their smartphone camera at this QR code to
                start their AI interview immediately.
              </p>
            </div>
          </div>
