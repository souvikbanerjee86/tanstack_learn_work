...
export function CandidateScheduleDialog({
  candidate,
  open,
  onOpenChange,
}: CandidateScheduleDialogProps) {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <DialogDescription className="text-xs sm:text-sm text-muted-foreground font-medium">
                  Generate calendar invites and invitation templates for this
                  candidate.
                </DialogDescription>
              </div>
            </div>
          ...
          <div className="p-4 rounded-2xl bg-muted/40 border border-border/60 backdrop-blur-md space-y-2">
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2">
                ...
                <Badge
                  variant="outline"
                  className="text-[10px] font-black uppercase bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border-indigo-500/20"
                >
            ...
            <div className="space-y-1.5">
              ...
              <Select value={interviewType} onValueChange={setInterviewType}>
                ...
                <SelectContent className="rounded-xl">
                  <SelectItem value="Technical & AI Review">
                    Technical & AI Review
                  </SelectItem>
                  <SelectItem value="System Architecture Round">
                    System Architecture
                  </SelectItem>
                  <SelectItem value="Hiring Manager Discussion">
                    Hiring Manager Round
                  </SelectItem>
                  <SelectItem value="HR & Culture Fit">
                    Culture & HR Fit
                  </SelectItem>
                </SelectContent>
              </Select>
