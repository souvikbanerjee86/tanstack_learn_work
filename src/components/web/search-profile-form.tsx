...
import type { PaginatedJobResponse, ProfileSearchCritieria } from '@/lib/types'
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground font-medium">
                  Fine-tune the AI match criteria for this role.
                </p>
              </div>
            </div>
          </DialogHeader>
                    ...
                    <div className="space-y-3">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          ...
                          const jobDescription = jobDetails.data.find(
                ...
                children={(field) => (
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge
                        variant="outline"
                        className="text-[9px] font-bold tracking-tighter bg-primary/5 text-primary"
                      >
                        AI ANALYZABLE
                      </Badge>
                    </div>
