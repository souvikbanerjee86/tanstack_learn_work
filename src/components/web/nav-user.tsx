          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              <div className="relative">
                <Avatar className="h-10 w-10 rounded-xl ring-2 ring-primary/5 group-hover/user:ring-primary/20 transition-all">
                  <AvatarImage
                    src={
                      user?.picture ??
                      'https://api.dicebear.com/9.x/glass/svg?seed=Aidan'
                    }
                    alt={user.name}
                  />
              ...
              <div className="grid flex-1 text-left text-sm leading-tight ml-1 group-data-[collapsible=icon]:hidden">
                ...
                <span className="truncate text-[10px] text-muted-foreground uppercase font-bold opacity-60 tracking-wider">
                  Intelligence Access
                </span>
              </div>
            ...
            <DropdownMenuLabel className="p-0 font-normal">
              <div className="flex items-center gap-3 px-3 py-4 text-left">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-black tracking-tight text-base">
                    {user?.name}
                  </span>
                  <span className="truncate text-xs text-muted-foreground font-medium opacity-70">
                    {user?.email}
                  </span>
                </div>
              </div>
