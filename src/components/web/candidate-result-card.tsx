import { Briefcase, CheckCircle2, AlertCircle, FileText, User, Loader2, ExternalLink, Calendar, Gauge, Clock, Columns } from "lucide-react";
        ...
        <div className="group relative">
            <Card className={cn(
                ...
                <div className={cn(
                    ...
                    data.matched_score > 80 ? "bg-emerald-500" : data.matched_score > 60 ? "bg-amber-500" : "bg-indigo-500"
                )} />
                        ...
                        <div className="flex gap-4 sm:gap-5 min-w-0">
                            ...
                            <div className="min-w-0">
                                ...
                                <div className="mt-1.5 flex items-center gap-1.5 text-[10px] text-muted-foreground/70 font-mono">
                                    ...
                                    <span className="truncate">{data.source_ref.split('/').pop()}</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="relative">
                                <div className={cn(
                                    ...
                                    <div className="flex items-baseline gap-1">
                                        <span className="text-xs font-bold uppercase tracking-wider opacity-70">Match</span>
                                        <span className="text-lg font-black tabular-nums">{data.matched_score}%</span>
                                    </div>
                                </div>
                            </div>
                ...
                <CardFooter className="bg-muted/30 p-4 px-6 sm:px-8 flex flex-col sm:flex-row gap-3 justify-between items-center border-t border-border/40">
                    <div className="flex items-center gap-4 text-xs font-medium text-muted-foreground">
                        <div className="flex items-center gap-1.5">
                            ...
                            <span>Notice: <strong className="text-foreground">{data.notice_period || "Immediate"}</strong></span>
                        </div>
                    </div>
