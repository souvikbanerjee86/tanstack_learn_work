...
export function QuestionsContent({
  ...
  const [simulatedQuestion, setSimulatedQuestion] = useState<string | null>(
    null,
  )
  ...
  const handleExportCSV = () => {
    ...
    exportToCSV(
      exportData,
      `question-bank-${jobTitle ? jobTitle.toLowerCase().replace(/\s+/g, '-') : 'export'}`,
    )
          ...
          <div className="flex flex-col items-center justify-center min-h-80 text-center p-6 sm:p-10 space-y-4">
            ...
            <div className="space-y-1 max-w-sm">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Add interview questions manually using the input above, or use
                the AI Assistant to generate tailored questions.
              </p>
            </div>
            {onOpenAiModal && (
              <Button
