  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      {isEvaluated ? (
        <Badge
          variant="outline"
          className="h-10 px-3.5 rounded-xl bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20 font-bold text-xs gap-1.5"
        >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-0.5 text-left">
                ...
                <DialogDescription className="text-xs text-muted-foreground font-medium">
                  Record your definitive recruitment decision and structured
                  feedback.
                </DialogDescription>
              </div>
            </div>
                    ...
                    >
                      ...
                      <SelectContent className="backdrop-blur-xl bg-white/95 dark:bg-zinc-900/95 border-border/60 rounded-xl">
                        <SelectGroup>
                          ...
                          <SelectItem
                            value="ACCEPT"
                            className="rounded-lg focus:bg-emerald-500/10 focus:text-emerald-600 dark:focus:text-emerald-400"
                          >
                          ...
                          <SelectItem
                            value="REJECT"
                            className="rounded-lg focus:bg-rose-500/10 focus:text-rose-600 dark:focus:text-rose-400"
                          >
                            <div className="flex items-center gap-2">
