    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerBanner}>
          <View>
            ...
            <Text style={styles.brandSubtitle}>
              Job Requisition Specification Dossier
            </Text>
          </View>
        ...
        <View style={styles.heroCard}>
          ...
          <Text style={styles.heroJobId}>
            Requisition ID: {job.job_id} | Document Generated:{' '}
        ...
        <View style={styles.specContainer}>
          <View style={styles.specHeader}>
            <Text style={styles.specHeaderText}>
              Job Mandate, Requirements & Scope
            </Text>
