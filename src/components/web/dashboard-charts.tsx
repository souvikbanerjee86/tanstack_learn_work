...
import { Activity, PieChartIcon, Target, TrendingUp } from 'lucide-react'
    ...
    <CardHeader className="flex flex-row items-center justify-between p-8 pb-4">
      <div className="flex items-center gap-5">
        ...
        <div>
          ...
          <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-widest mt-0.5 opacity-50">
            Intelligence Stream
          </p>
        </div>
      </div>
      <Badge
        variant="secondary"
        className="text-[10px] font-black tracking-[0.2em] uppercase px-4 py-1.5 rounded-full border border-border bg-muted/50"
      >
        DATA READY
      </Badge>
    </CardHeader>
