      ...
      startGenerating(async () => {
        try {
          const jobDescription = await getJobDescription({
            data: { job_title: jobTitle, experience: experience },
          })
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex flex-col gap-8 pb-4 border-b border-muted-foreground/10 relative">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <Badge
              variant="outline"
              className="h-7 px-4 rounded-full border-primary/20 text-primary bg-primary/5 text-[9px] font-black uppercase tracking-[0.2em] mb-1"
            >
              New Deployment
            </Badge>
          </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground font-medium opacity-60 italic">
                        Define the core identification for this position.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground font-medium opacity-60 italic">
                        Where and how will this talent operate?
                      </p>
                    </div>
                  </div>
                                      ...
                                      indianStates
                                        ...
                                        .map((s) => (
                                          <Badge
                                            key={s}
                                            variant="secondary"
                                            className="font-bold text-[10px] uppercase tracking-tighter bg-primary/10 text-primary border-primary/10 px-2 h-5"
                                          >
                                            {s}
                                          </Badge>
                                        ))
                                    ) : (
                                      <span className="text-muted-foreground text-sm opacity-40 italic font-medium">
                              ...
                              <PopoverContent className="w-[--radix-popover-trigger-width] p-1 rounded-3xl overflow-hidden shadow-2xl border-muted-foreground/10 backdrop-blur-xl bg-card/90">
                                <Command className="bg-transparent">
                                  <CommandInput
                                    ...
                                    className="h-12 border-none bg-muted/50"
                                  />
                                  <CommandList className="max-h-[300px] p-1">
                                    <CommandEmpty className="p-6 text-center text-xs text-muted-foreground font-semibold">
                                          ...
                                          <div
                                            className={cn(
                                              ...
                                              selectedValues.has(state)
                                                ? 'bg-primary border-primary scale-110 shadow-[0_0_12px_hsl(var(--primary))]'
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground font-medium opacity-60 italic">
                          Synthesize the expectations for this campaign.
                        </p>
                      </div>
                    </div>
                        ...
                        <Field className="space-y-3">
                          ...
                          <div className="relative group/input">
                            ...
                            <Input
                              ...
                              className="h-14 pl-12 rounded-2xl bg-card border-muted-foreground/10 focus:ring-primary/20 transition-all shadow-sm"
                            />
                          </div>
                        </Field>
                      )}
            ...
            <div className="pt-8 flex items-center justify-end gap-6 border-t border-border">
              ...
              >
                ...
                <span className="text-xs font-black uppercase tracking-widest">
                  {isPending ? 'Creating...' : 'Publish Job'}
                </span>
              </Button>
            </div>
          </form>
