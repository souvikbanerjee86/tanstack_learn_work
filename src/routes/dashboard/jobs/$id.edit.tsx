...
function RouteComponent() {
  ...
  const form = useForm({
    defaultValues: {
      ...
      locations: locationInfo as Array<string>,
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="space-y-1">
                ...
                <CardDescription className="text-base font-medium text-slate-500 dark:text-slate-400">
                  Refine the listing details for{' '}
              ...
              <FieldGroup className="space-y-12">
                ...
                <div className="space-y-8">
                  <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-800 pb-4">
                    ...
                    <h3 className="text-lg font-bold tracking-tight text-slate-900 dark:text-white uppercase text-[11px] opacity-70">
                      Role Essentials
                    </h3>
                  </div>
                ...
                <div className="space-y-8">
                  <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-800 pb-4">
                    ...
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white uppercase tracking-widest text-[11px] opacity-70">
                    ...
                    <form.Field
                      ...
                      children={(field) => (
                        <Field className="space-y-2.5">
                          <FieldLabel className="text-sm font-bold text-slate-700 dark:text-slate-300 ml-1">
                            Employment Type
                          </FieldLabel>
                          <Select
                                      ...
                                      indianStates
                                        ...
                                        .map((s) => (
                                          <Badge
                                            key={s}
                                            variant="secondary"
                                            className="font-bold text-[10px] uppercase tracking-wider bg-indigo-50 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 ring-1 ring-indigo-200/50 dark:ring-indigo-800/50"
                                          >
                                            {s}
                                          </Badge>
                                        ))
                                    ...
                                    <CommandGroup>
                                      {indianStates.map((state) => (
                                        ...
                                        >
                                          ...
                                          {selectedValues.has(state) && (
                                            <Sparkles className="h-3 text-indigo-500" />
                                          )}
                                        </CommandItem>
                                      ))}
                                    </CommandGroup>
                  ...
                  <form.Field
                    ...
                    children={(field) => {
                      ...
                      return (
                        <Field
                          data-invalid={isInvalid}
                          className="relative group/textarea"
                        >
                          <Textarea
                            id={field.name}
                            value={field.state.value}
                      ...
                      children={(field) => (
                        <Field className="space-y-2.5">
                          ...
                          <Input
                            ...
                            value={field.state.value}
                            onChange={(e) => field.handleChange(e.target.value)}
                            className="h-12 bg-white/50 dark:bg-slate-950/50 border-slate-200/60 dark:border-slate-800 rounded-xl"
                          />
                        </Field>
                      )}
                    />
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              ...
                              <SelectContent className="backdrop-blur-xl bg-white/95 dark:bg-slate-900/95 border-slate-200/60 dark:border-slate-800">
                                <SelectGroup>
                                  <SelectLabel className="text-xs uppercase tracking-widest font-bold opacity-70">
                                    Years of Experience
                                  </SelectLabel>
