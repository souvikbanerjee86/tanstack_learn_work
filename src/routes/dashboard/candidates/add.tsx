...
function CandidateAddContent() {
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      if (imgBase64) formData.append('candidate_image', imgBase64)
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground font-medium opacity-60 italic">
                        Link candidate to an active job opening.
                      </p>
                    </div>
                  </div>
                          ...
                          <Field data-invalid={isInvalid} className="space-y-3">
                            ...
                            <Select
                              ...
                              onValueChange={(value) => {
                                ...
                                const jobName = jobDetails.data.find(
                                  (job) => job.job_id === value,
                                )?.job_title as string
                        ...
                        <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed rounded-3xl cursor-pointer bg-card hover:bg-muted/30 border-muted-foreground/10 transition-all group/upload relative overflow-hidden">
                          {imgBase64 ? (
                            <img
                              src={imgBase64}
                              alt="Preview"
                              className="h-full w-full object-cover p-1 rounded-[1.5rem]"
                            />
                          ) : (
